...
| اجتماعی | کمک به استفاده مسئولانه از سامانه‌های تصمیم‌یار در سلامت |
...
| مستندات | اجراشده؛ دانشنامه واقعی Notion و Project واقعی Jira با شواهد متقابل |
...
| Jira واقعی | اجراشده؛ پروژه EMD با ۹ Epic و ۵۱ Story/Task، وضعیت و Evidence واقعی |
| Notion واقعی | اجراشده؛ ۸ صفحه، ۵ دیتابیس و ۷۵ رکورد |
| Android | APK و AAB امضاشده آماده‌اند؛ تست نصب روی دستگاه واقعی هنوز باز است |
...
- Jira و Notion واقعی ساخته شده‌اند؛ screenshot رابط آن‌ها هنوز باید طبق راهنمای تصویربرداری ثبت و به Evidence افزوده شود.
