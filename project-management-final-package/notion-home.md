...
# امداد یار | دانشنامه پروژه و مدیریت دانش
        ...
        | بازخورد ذی‌نفعان | بازخورد خارجی تأییدشده هنوز نیاز به تکمیل دارد؛ ۹ بازخورد پرستار تریاژ در وضعیت pending confirmation است | <span dir="ltr">docs/triage-nurse-feedback-confirmation.md</span> |
