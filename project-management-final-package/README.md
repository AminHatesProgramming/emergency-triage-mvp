...
این پوشه نسخه قابل بازسازی و قابل ممیزی دانشنامه Notion و پروژه Jira «امداد یار» است. فایل‌ها فارسی، راست‌چین و همراه با Evidence Link هستند. انتقال اولیه در ۲۰۲۶-۰۷-۱۶ و ممیزی نهایی همگام‌سازی در ۲۰۲۶-۰۷-۱۸ انجام شده است.
...
| فایل | کاربرد |
|---|---|
| <span dir="ltr">notion-home.md</span> | صفحه اصلی Notion |
| <span dir="ltr">notion-project-overview.md</span> | شرح کامل پروژه |
| <span dir="ltr">notion-product-features.md</span> | مستند قابلیت‌های محصول |
| <span dir="ltr">notion-decision-log.csv</span> | دیتابیس تصمیم‌ها |
| <span dir="ltr">notion-change-log.csv</span> | دیتابیس تغییرات از git history |
...
وضعیت هر شاهد بر اساس اطلاعات موجود ثبت شده است. تصویر نهایی رابط Jira/Notion، حساب دو عضو تیم، Worklog شخصی، آزمون فیزیکی QR/PWA، نصب APK روی گوشی واقعی، پاسخ نهایی مراکز و اعتبارسنجی بالینی همچنان جدا و صریح در <span dir="ltr">missing-info-checklist.md</span> باز مانده‌اند.
</div>
