...
def build_qa_test_log() -> None:
    rows = [
        ("QA-01", "فرم خالی", "هیچ شکایت یا علامت حیاتی وارد نشود و ارزیابی اجرا شود", "عدم پیش‌بینی؛ نمایش پیام روشن برای ورود حداقل یک نشانه بالینی و پاسخ 422 در API", "در تست خودکار مرورگر و API، فرم خالی بدون برآورد ریسک متوقف شد", "Passed", "محمدامین پورمند / آزمون خودکار", "2026-07-12", "QA-01"),
