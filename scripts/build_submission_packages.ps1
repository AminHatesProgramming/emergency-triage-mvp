...
$coreMappings = @{
    ...
    (Join-Path $root "reports\model\ui_smoke_public_v7.json") = "ui_smoke_public_v7.json"
    (Join-Path $root "reports\model\android_wrapper_ui_v1.json") = "android_wrapper_ui_v1.json"
    (Join-Path $root "reports\deliverable-docx-audit.json") = "deliverable-docx-audit.json"
    (Join-Path $root "reports\project-management-package-audit.json") = "project-management-package-audit.json"
    (Join-Path $root "docs\market\Emdadyar_Android_Market_Release_1.0.0.zip") = "Emdadyar_Android_Market_Release_1.0.0.zip"
    (Join-Path $root "docs\market\device-test-checklist-fa.md") = "device-test-checklist-fa.md"
    (Join-Path $root "project-management-final-package\final-screenshot-evidence-guide.md") = "final-screenshot-evidence-guide.md"
    ...
    (Join-Path $root "docs\market\screenshots\emdadyar-mobile-android-wrapper.png") = "emdadyar-mobile-android-wrapper.png"
    (Join-Path $root "docs\market\screenshots\emdadyar-mobile-guide.png") = "emdadyar-mobile-guide.png"
