...
def build_docx() -> None:
    ...
    run = title.add_run("نسخه نهایی موبایل و وب‌اپ «امداد یار»")
    ...
    status_rows = [
        ...
        ("راهنمای سه‌مرحله‌ای داخل برنامه", "آماده"),
    ...
    add_body(
        doc,
        "برای نمایش خروجی، چند داده حیاتی بیمار را وارد کنید و دکمه «ارزیابی» را بزنید. تب «راهنما» مسیر کار را در سه گام کوتاه نشان می‌دهد. حتی با چند ورودی محدود نیز سامانه یک ارزیابی اولیه ارائه می‌دهد و میزان کامل بودن اطلاعات را جداگانه نمایش می‌دهد.",
    )
