...
# بسته انتشار اندروید امدادیار

این پوشه خروجی فنی و محتوایی نسخه ۱.۰.۰ امدادیار برای انتشار آزمایشی در بازارهای اندرویدی را نگهداری می‌کند. برنامه یک WebView آفلاین است؛ رابط فارسی و مدل مرورگری نسخه ۷ داخل APK قرار دارند و ارزیابی بیمار به سرور ارسال نمی‌شود.
