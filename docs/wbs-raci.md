...
| 1.1 | تحلیل rubric استاد | checklist نمره‌دهی | محمدرضا |
...
این RACI نشان می‌دهد هر عضو نقش مشخص دارد، اما بار پیچیده فنی روی محمدامین است و نقش دو عضو دیگر طوری تعریف شده که در ارائه قابل توضیح و واقعی باشد.
